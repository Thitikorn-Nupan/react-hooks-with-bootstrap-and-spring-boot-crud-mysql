package com.ttknp.springbootcrudforreacthooksandformik;
...
public class SpringBootCrudForReactHooksAndFormikApplication {

    public static void main(String[] args) {
        SpringApplication.run(SpringBootCrudForReactHooksAndFormikApplication.class, args);
    }
